...
public:
	...
	virtual void warmPancake() // Sets the default target warming to 65 Celsius which is overloaded in each pancake subclass
	{
...
public:
	...
	void makeSelection(int option){ //Takes in the option and then creates a pancake with the correct filling
		switch (option)
		{
		case 15:
		{
	...
	void SelectCoating(Pancake* selectedFilling){
		...
		case 1:
		{
			...
			SelectCoating(selectedFilling); //Recursive call to allow multiple coatings
			break;
		}
		case 2:
		{
